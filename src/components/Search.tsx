...
function HighlightQuery({ text, query }: { text: string; query: string }) {
  return (
    <Highlighter
      highlightClassName="group-aria-selected:underline bg-transparent text-[#A04EA3] dark:text-[#EEB5F0]"
      searchWords={[query]}
      autoEscape={true}
  ...
  return (
    ...
    >
      <div
        id={`${id}-title`}
        aria-hidden="true"
        className="text-sm text-zinc-700 group-aria-selected:text-[#A04EA3] dark:text-zinc-300 dark:group-aria-selected:text-[#EEB5F0]"
      >
...
export function Search({ navigation }: { navigation: NavTree }) {
  ...
  return (
    <>
      ...
      <SearchDialog {...dialogProps} navigation={navigation} />
    </>
  )
}
